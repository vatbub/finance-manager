...
abstract class ObjectEditingCell<TData, TColumn>(private val converter: StringConverter<TColumn>) :
    TableCell<TData, TColumn>() {
    ...
    override fun updateItem(item: TColumn?, empty: Boolean) {
    ...
    override fun commitEdit(newValue: TColumn) {
        super.commitEdit(newValue)
        updateItemPropertyValue(tableRow.item, newValue)
    }

    abstract fun updateItemPropertyValue(item: TData, newValue: TColumn)
}
